                ...
                <div class="swiper-wrapper">
                    ...
                    <?php while (have_rows('glavnaya_-_slajder')): the_row();
                        ...
                        <div class="swiper-slide">
                            <div class="banner-slide" style="background-image: url('<?php echo $izobrazhenie; ?>')">
                                ...
                                <a class="btn btn-border-white banner__btn js-query">ОСТАВИТЬ ЗАЯВКУ</a>
                            </div>
                        </div>
                ...
                <a href="#" class="catalog-item catalog-item-big">
                    ...
                    <span class="catalog-item__content">
                      <span class="catalog-item__title">
                        <b><?php echo $nazvanie; ?></b>
                          <br>
                        <?php echo $nazvanie_2ya_chast; ?>
                      </span>
                    </span>
                </a>
        ...
        <?php while (have_rows('glavnaya_-_preimushhestva')): the_row();
            ...
            <div class="catalog-item catalog-item-big">
                ...
                <div class="catalog-item__content">
                    <h3 class="catalog-item__title"><?php echo $nazvanie; ?></h3>
