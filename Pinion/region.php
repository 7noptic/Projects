                                                ...
                                                <?php if (have_rows('pod_rajon')): ?>
                                                    ...
                                                    <nav class="subregion__nav">
                                                        ...
                                                        <?php while (have_rows('pod_rajon')): the_row();
                                                            ...
                                                            ?>
                                                            <a href="#"
                                                               class="subregion__link js-subregion-link"><?php echo $content; ?></a>
                                                                    ...
                                                                    <?php if (have_rows('product-post')): ?>
                                                                        ...
                                                                        <?php while (have_rows('product-post')): the_row();
                                                                            ...
                                                                            <div class="swiper-slide">
                                                                                <a href="<?php echo $link; ?>" class="region-card">
                                                                                    <div class="region-card__img">
                                                                                        <img src="<?php echo DOMEO_DIR_IMG ?>/rci.svg"
                                                                                             alt="">
                                                                                    </div>
                                                                                    ...
                                                                                    <p class="region-card__link">ПОДРОБНЕЕ</p>
